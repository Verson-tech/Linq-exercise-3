...
namespace LinqExercise
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            employees.Where(x=>x.FirstName.ToLower().StartsWith('c') || x.FirstName.StartsWith('s')).OrderBy(x=> x.FirstName).ToList().ForEach(x => Console.WriteLine(x.FullName));
            ...
            Console.WriteLine(Math.Round(averageYOE, 2));
            //TODO: Add an employee to the end of the list without using employees.Add()
            employees = employees.Append(new Employee ("John","Doe", 31,2)).ToList();
